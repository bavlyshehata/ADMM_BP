set moduleName krnl_bp_Pipeline_l_vec_sub
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {krnl_bp_Pipeline_l_vec_sub}
set C_modelType { void 0 }
set C_modelArgList {
	{ z_copy_2_stream int 32 regular {fifo 0 volatile } {global 0}  }
	{ u_copy_1_stream int 32 regular {fifo 0 volatile } {global 0}  }
	{ z_u_stream int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "z_copy_2_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "u_copy_1_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "z_u_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ z_copy_2_stream_dout sc_in sc_lv 32 signal 0 } 
	{ z_copy_2_stream_empty_n sc_in sc_logic 1 signal 0 } 
	{ z_copy_2_stream_read sc_out sc_logic 1 signal 0 } 
	{ u_copy_1_stream_dout sc_in sc_lv 32 signal 1 } 
	{ u_copy_1_stream_empty_n sc_in sc_logic 1 signal 1 } 
	{ u_copy_1_stream_read sc_out sc_logic 1 signal 1 } 
	{ z_u_stream_din sc_out sc_lv 32 signal 2 } 
	{ z_u_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ z_u_stream_write sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "u_copy_1_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "u_copy_1_stream", "role": "dout" }} , 
 	{ "name": "u_copy_1_stream_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "u_copy_1_stream", "role": "empty_n" }} , 
 	{ "name": "u_copy_1_stream_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "u_copy_1_stream", "role": "read" }} , 
...
set Spec2ImplPortList { 
	z_copy_2_stream { ap_fifo {  { z_copy_2_stream_dout fifo_port_we 0 32 }  { z_copy_2_stream_empty_n fifo_status 0 1 }  { z_copy_2_stream_read fifo_data 1 1 } } }
	u_copy_1_stream { ap_fifo {  { u_copy_1_stream_dout fifo_port_we 0 32 }  { u_copy_1_stream_empty_n fifo_status 0 1 }  { u_copy_1_stream_read fifo_data 1 1 } } }
	z_u_stream { ap_fifo {  { z_u_stream_din fifo_port_we 1 32 }  { z_u_stream_full_n fifo_status 0 1 }  { z_u_stream_write fifo_data 1 1 } } }
}
