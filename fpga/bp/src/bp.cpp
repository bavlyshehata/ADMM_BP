...
static constexpr int WORDS_MAX   = (MAX_N + VEC - 1) / VEC;
static constexpr int N0_MAX      = MAX_N / 2;
static constexpr int N1_MAX      = MAX_N - N0_MAX;
static constexpr int MAT0_WORDS_MAX = N0_MAX * WORDS_MAX;
static constexpr int MAT1_WORDS_MAX = N1_MAX * WORDS_MAX;
