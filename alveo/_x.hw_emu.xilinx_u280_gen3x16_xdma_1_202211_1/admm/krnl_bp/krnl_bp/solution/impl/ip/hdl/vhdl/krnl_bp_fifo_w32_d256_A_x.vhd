...
entity krnl_bp_fifo_w32_d256_A_x is
    generic (
...
architecture arch of krnl_bp_fifo_w32_d256_A_x is

    -- component
    component krnl_bp_fifo_w32_d256_A_x_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_krnl_bp_fifo_w32_d256_A_x_ram : krnl_bp_fifo_w32_d256_A_x_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity krnl_bp_fifo_w32_d256_A_x_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 8;
...
architecture arch of krnl_bp_fifo_w32_d256_A_x_ram is
