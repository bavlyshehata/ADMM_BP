...
entity krnl_bp_fifo_w32_d128_A is
    generic (
...
architecture arch of krnl_bp_fifo_w32_d128_A is

    -- component
    component krnl_bp_fifo_w32_d128_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_krnl_bp_fifo_w32_d128_A_ram : krnl_bp_fifo_w32_d128_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity krnl_bp_fifo_w32_d128_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 7;
...
architecture arch of krnl_bp_fifo_w32_d128_A_ram is
