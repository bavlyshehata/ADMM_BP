set moduleName mac_Pipeline_VITIS_LOOP_234_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {mac_Pipeline_VITIS_LOOP_234_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ mat_p_bram float 32 regular {array 64 { 1 3 } 1 1 } {global 0}  }
	{ p_stream int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mat_p_bram", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "p_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ p_stream_din sc_out sc_lv 32 signal 1 } 
	{ p_stream_full_n sc_in sc_logic 1 signal 1 } 
	{ p_stream_write sc_out sc_logic 1 signal 1 } 
...
set Spec2ImplPortList { 
	mat_p_bram { ap_memory {  { mat_p_bram_address0 mem_address 1 6 }  { mat_p_bram_ce0 mem_ce 1 1 }  { mat_p_bram_q0 in_data 0 32 } } }
	p_stream { ap_fifo {  { p_stream_din fifo_port_we 1 32 }  { p_stream_full_n fifo_status 0 1 }  { p_stream_write fifo_data 1 1 } } }
}
