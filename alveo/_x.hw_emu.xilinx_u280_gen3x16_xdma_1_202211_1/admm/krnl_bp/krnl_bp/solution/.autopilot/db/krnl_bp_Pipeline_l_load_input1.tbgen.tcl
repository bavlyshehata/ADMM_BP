set moduleName krnl_bp_Pipeline_l_load_input1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {krnl_bp_Pipeline_l_load_input1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1_load int 256 regular  }
	{ vec_q_bram float 32 regular {array 8 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1_load", "interface" : "wire", "bitwidth" : 256, "direction" : "READONLY"} , 
 	{ "Name" : "vec_q_bram", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ vec_q_bram_address0 sc_out sc_lv 3 signal 1 } 
	{ vec_q_bram_ce0 sc_out sc_logic 1 signal 1 } 
	{ vec_q_bram_we0 sc_out sc_logic 1 signal 1 } 
	{ vec_q_bram_d0 sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "vec_q_bram_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vec_q_bram", "role": "we0" }} , 
 	{ "name": "vec_q_bram_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "vec_q_bram", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	vec_q_bram { ap_memory {  { vec_q_bram_address0 mem_address 1 3 }  { vec_q_bram_ce0 mem_ce 1 1 }  { vec_q_bram_we0 mem_we 1 1 }  { vec_q_bram_d0 mem_din 1 32 } } }
}
