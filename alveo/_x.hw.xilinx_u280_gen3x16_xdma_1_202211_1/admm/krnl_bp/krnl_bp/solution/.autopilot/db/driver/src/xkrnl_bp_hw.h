...
#define XKRNL_BP_CONTROL_ADDR_N_DATA          0x44
#define XKRNL_BP_CONTROL_BITS_N_DATA          32
#define XKRNL_BP_CONTROL_ADDR_CHUNK_SIZE_DATA 0x4c
#define XKRNL_BP_CONTROL_BITS_CHUNK_SIZE_DATA 32
