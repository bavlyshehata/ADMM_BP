...
entity krnl_bp_control_s_axi is
generic (
...
end entity krnl_bp_control_s_axi;
...
-- 0x48 : reserved
-- 0x4c : Data signal of chunk_size
--        bit 31~0 - chunk_size[31:0] (Read/Write)
-- 0x50 : reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of krnl_bp_control_s_axi is
    ...
    constant ADDR_MAT_P_DATA_0      : INTEGER := 16#10#;
    constant ADDR_MAT_P_DATA_1      : INTEGER := 16#14#;
    constant ADDR_MAT_P_CTRL        : INTEGER := 16#18#;
    constant ADDR_VEC_Q_DATA_0      : INTEGER := 16#1c#;
    constant ADDR_VEC_Q_DATA_1      : INTEGER := 16#20#;
    constant ADDR_VEC_Q_CTRL        : INTEGER := 16#24#;
    constant ADDR_OUT_R_DATA_0      : INTEGER := 16#28#;
    constant ADDR_OUT_R_DATA_1      : INTEGER := 16#2c#;
    constant ADDR_OUT_R_CTRL        : INTEGER := 16#30#;
    constant ADDR_RHO_DATA_0        : INTEGER := 16#34#;
    constant ADDR_RHO_CTRL          : INTEGER := 16#38#;
    constant ADDR_ALPHA_DATA_0      : INTEGER := 16#3c#;
    constant ADDR_ALPHA_CTRL        : INTEGER := 16#40#;
    constant ADDR_N_DATA_0          : INTEGER := 16#44#;
    constant ADDR_N_CTRL            : INTEGER := 16#48#;
    constant ADDR_CHUNK_SIZE_DATA_0 : INTEGER := 16#4c#;
    constant ADDR_CHUNK_SIZE_CTRL   : INTEGER := 16#50#;
    ...
    signal int_mat_p           : UNSIGNED(63 downto 0) := (others => '0');
    signal int_vec_q           : UNSIGNED(63 downto 0) := (others => '0');
    signal int_out_r           : UNSIGNED(63 downto 0) := (others => '0');
    signal int_rho             : UNSIGNED(31 downto 0) := (others => '0');
    signal int_alpha           : UNSIGNED(31 downto 0) := (others => '0');
    signal int_N               : UNSIGNED(31 downto 0) := (others => '0');
    signal int_chunk_size      : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_MAT_P_DATA_0 =>
                        rdata_data <= RESIZE(int_mat_p(31 downto 0), 32);
                    when ADDR_MAT_P_DATA_1 =>
                        rdata_data <= RESIZE(int_mat_p(63 downto 32), 32);
                    when ADDR_VEC_Q_DATA_0 =>
                        rdata_data <= RESIZE(int_vec_q(31 downto 0), 32);
                    when ADDR_VEC_Q_DATA_1 =>
                        rdata_data <= RESIZE(int_vec_q(63 downto 32), 32);
                    ...
                    when ADDR_CHUNK_SIZE_DATA_0 =>
                        rdata_data <= RESIZE(int_chunk_size(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAT_P_DATA_0) then
                    int_mat_p(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_mat_p(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAT_P_DATA_1) then
                    int_mat_p(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_mat_p(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_VEC_Q_DATA_0) then
                    int_vec_q(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_vec_q(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_VEC_Q_DATA_1) then
                    int_vec_q(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_vec_q(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CHUNK_SIZE_DATA_0) then
                    int_chunk_size(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_chunk_size(31 downto 0));
                end if;
            end if;
        end if;
    end process;
