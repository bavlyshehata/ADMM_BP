set moduleName krnl_bp_Pipeline_VITIS_LOOP_526_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {krnl_bp_Pipeline_VITIS_LOOP_526_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ alpha float 32 regular  }
	{ reg_alpha float 32 regular  }
	{ x_stream int 32 regular {fifo 0 volatile } {global 0}  }
	{ z_old_stream int 32 regular {fifo 0 volatile } {global 0}  }
	{ x_hat_stream int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "alpha", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "reg_alpha", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "x_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "z_old_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "x_hat_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ x_stream_dout sc_in sc_lv 32 signal 2 } 
	{ x_stream_empty_n sc_in sc_logic 1 signal 2 } 
	{ x_stream_read sc_out sc_logic 1 signal 2 } 
	{ z_old_stream_dout sc_in sc_lv 32 signal 3 } 
	{ z_old_stream_empty_n sc_in sc_logic 1 signal 3 } 
	{ z_old_stream_read sc_out sc_logic 1 signal 3 } 
	{ x_hat_stream_din sc_out sc_lv 32 signal 4 } 
	{ x_hat_stream_full_n sc_in sc_logic 1 signal 4 } 
	{ x_hat_stream_write sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "x_stream", "role": "dout" }} , 
 	...
 	{ "name": "x_hat_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "x_hat_stream", "role": "din" }} , 
 	{ "name": "x_hat_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "x_hat_stream", "role": "full_n" }} , 
 	{ "name": "x_hat_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "x_hat_stream", "role": "write" }} , 
...
set Spec2ImplPortList { 
	...
	x_stream { ap_fifo {  { x_stream_dout fifo_port_we 0 32 }  { x_stream_empty_n fifo_status 0 1 }  { x_stream_read fifo_data 1 1 } } }
	z_old_stream { ap_fifo {  { z_old_stream_dout fifo_port_we 0 32 }  { z_old_stream_empty_n fifo_status 0 1 }  { z_old_stream_read fifo_data 1 1 } } }
	x_hat_stream { ap_fifo {  { x_hat_stream_din fifo_port_we 1 32 }  { x_hat_stream_full_n fifo_status 0 1 }  { x_hat_stream_write fifo_data 1 1 } } }
}
