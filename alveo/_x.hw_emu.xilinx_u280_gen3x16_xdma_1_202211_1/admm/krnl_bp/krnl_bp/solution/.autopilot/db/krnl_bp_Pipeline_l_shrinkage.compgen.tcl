...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_x_hat_u_stream \
    op interface \
    ports { x_hat_u_stream_dout { I 32 vector } x_hat_u_stream_empty_n { I 1 bit } x_hat_u_stream_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { z_stream_din { O 32 vector } z_stream_full_n { I 1 bit } z_stream_write { O 1 bit } } \
} "
}
