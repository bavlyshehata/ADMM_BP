...
int main(int /*argc*/, char** /*argv*/) {
    ...
    constexpr int WORDS_MAX = (MAX_N + VEC - 1) / VEC;
    constexpr int N0_MAX    = MAX_N / 2;
    constexpr int N1_MAX    = MAX_N - N0_MAX;
    constexpr int MAT0_WORDS_MAX = N0_MAX * WORDS_MAX;
    constexpr int MAT1_WORDS_MAX = N1_MAX * WORDS_MAX;
    ...
    const bool   do_termination = false;
