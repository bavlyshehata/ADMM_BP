set moduleName krnl_bp_Pipeline_VITIS_LOOP_514_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {krnl_bp_Pipeline_VITIS_LOOP_514_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ x_stream int 32 regular {fifo 2 volatile } {global 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "x_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READWRITE", "extern" : 0} ]}
...
set portList { 
	...
	{ x_stream_dout sc_in sc_lv 32 signal 0 } 
	{ x_stream_empty_n sc_in sc_logic 1 signal 0 } 
	{ x_stream_read sc_out sc_logic 1 signal 0 } 
	{ x_stream_din sc_out sc_lv 32 signal 0 } 
	{ x_stream_full_n sc_in sc_logic 1 signal 0 } 
	{ x_stream_write sc_out sc_logic 1 signal 0 } 
...
set Spec2ImplPortList { 
	x_stream { ap_fifo {  { x_stream_dout fifo_port_we 0 32 }  { x_stream_empty_n fifo_status 0 1 }  { x_stream_read fifo_data 1 1 }  { x_stream_din fifo_port_we 1 32 }  { x_stream_full_n fifo_status 0 1 }  { x_stream_write fifo_data 1 1 } } }
}
