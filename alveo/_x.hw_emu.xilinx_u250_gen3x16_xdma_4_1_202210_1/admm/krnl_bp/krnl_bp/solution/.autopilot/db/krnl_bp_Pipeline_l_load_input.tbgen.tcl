set moduleName krnl_bp_Pipeline_l_load_input
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {krnl_bp_Pipeline_l_load_input}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 512 regular {axi_master 0}  }
	{ sext_ln15 int 58 regular  }
	{ mat_p_bram float 32 regular {array 64 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "mat_p","offset": { "type": "dynamic","port_name": "mat_p","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln15", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "mat_p_bram", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ sext_ln15 sc_in sc_lv 58 signal 1 } 
	{ mat_p_bram_address0 sc_out sc_lv 6 signal 2 } 
	{ mat_p_bram_ce0 sc_out sc_logic 1 signal 2 } 
	{ mat_p_bram_we0 sc_out sc_logic 1 signal 2 } 
	{ mat_p_bram_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln15", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln15", "role": "default" }} , 
 	...
 	{ "name": "mat_p_bram_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mat_p_bram", "role": "we0" }} , 
 	{ "name": "mat_p_bram_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mat_p_bram", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln15 { ap_none {  { sext_ln15 in_data 0 58 } } }
	mat_p_bram { ap_memory {  { mat_p_bram_address0 mem_address 1 6 }  { mat_p_bram_ce0 mem_ce 1 1 }  { mat_p_bram_we0 mem_we 1 1 }  { mat_p_bram_d0 mem_din 1 32 } } }
}
