set moduleName krnl_bp_Pipeline_l_shrinkage
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {krnl_bp_Pipeline_l_shrinkage}
set C_modelType { void 0 }
set C_modelArgList {
	{ rho float 32 regular  }
	{ x_hat_u_stream int 32 regular {fifo 0 volatile } {global 0}  }
	{ z_stream int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "rho", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "x_hat_u_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "z_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ x_hat_u_stream_dout sc_in sc_lv 32 signal 1 } 
	{ x_hat_u_stream_empty_n sc_in sc_logic 1 signal 1 } 
	{ x_hat_u_stream_read sc_out sc_logic 1 signal 1 } 
	{ z_stream_din sc_out sc_lv 32 signal 2 } 
	{ z_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ z_stream_write sc_out sc_logic 1 signal 2 } 
	{ rho sc_in sc_lv 32 signal 0 } 
	...
	{ grp_fu_656_p_opcode sc_out sc_lv 5 signal -1 } 
	{ grp_fu_656_p_dout0 sc_in sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_hat_u_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "x_hat_u_stream", "role": "dout" }} , 
 	{ "name": "x_hat_u_stream_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "x_hat_u_stream", "role": "empty_n" }} , 
 	{ "name": "x_hat_u_stream_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "x_hat_u_stream", "role": "read" }} , 
 	{ "name": "z_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "z_stream", "role": "din" }} , 
 	{ "name": "z_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "z_stream", "role": "full_n" }} , 
 	{ "name": "z_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "z_stream", "role": "write" }} , 
 	...
 	{ "name": "grp_fu_656_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "grp_fu_656_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_656_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_656_p_dout0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fsub_32ns_32ns_32_7_full_dsp_1_U59", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fsub_32ns_32ns_32_7_full_dsp_1_U60", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	x_hat_u_stream { ap_fifo {  { x_hat_u_stream_dout fifo_port_we 0 32 }  { x_hat_u_stream_empty_n fifo_status 0 1 }  { x_hat_u_stream_read fifo_data 1 1 } } }
	z_stream { ap_fifo {  { z_stream_din fifo_port_we 1 32 }  { z_stream_full_n fifo_status 0 1 }  { z_stream_write fifo_data 1 1 } } }
}
