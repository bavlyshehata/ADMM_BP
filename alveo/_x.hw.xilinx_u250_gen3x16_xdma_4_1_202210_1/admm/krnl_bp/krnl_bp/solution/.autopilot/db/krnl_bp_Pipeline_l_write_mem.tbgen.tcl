set moduleName krnl_bp_Pipeline_l_write_mem
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {krnl_bp_Pipeline_l_write_mem}
...
set portList { 
	...
	{ shiftreg_out sc_out sc_lv 256 signal 0 } 
	{ shiftreg_out_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ x_bram_address0 sc_out sc_lv 3 signal 1 } 
	{ x_bram_ce0 sc_out sc_logic 1 signal 1 } 
	{ x_bram_q0 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
